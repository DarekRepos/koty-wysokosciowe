...
(defun c:kp (/ FirstAltitude NextAltitude NApositionY FApositionY NApositionX FApositionX OffsetY OffsetX vals)
  (vl-load-com)
  ...
  (while ;;(and (setq vals (grread 't)) (/= (car vals) 3))

	;;(if (and (cadr vals) (= (car vals) 5)))
    ...
    (setq NApositionY (strcat
     ...
     (setq FApositionY	(strcat
		  ...
		  ">%"
		  " + " ;;plus constant
		  (rtos *ans*);;value at First Altitude = constant
		)
     )
     (setq NApositionX	(strcat
		  "%<\\AcObjProp Object(%<\\_ObjId "
		  (LM:ObjectID NextAltitude)
		  ">%).InsertionPoint \\f \""
		  "%lu2%pt1%pr3"
